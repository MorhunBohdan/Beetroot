<template>
  ...
  <div class="series-list__main conteiner">
    <div class="series-list__main-filter">
      <h2 class="series-list__main-filter-options">Filter Option</h2>
      <div class="series-list__main-filter-category">
        <h3 class="series-list__main-filter-category-title">By Category</h3>
        <div class="series-list__main-filter-category-checkboxes">
          <div class="series-list__main-filter-category-checkboxes-item">
            <input class="series-list__main-filter-category-checkbox-input" type="checkbox" id="label-1" name="Action">
            <label class="series-list__main-filter-category-checkbox-label" for="label-1">Action 1</label>
          </div>
          <div class="series-list__main-filter-category-checkboxes-item">
            <input class="series-list__main-filter-category-checkbox-input" type="checkbox" name="Action">
            <label class="series-list__main-filter-category-checkbox-label" for="Action">Action 1</label>
          </div>
          <div class="series-list__main-filter-category-checkboxes-item">
            <input class="series-list__main-filter-category-checkbox-input" type="checkbox" name="Action">
            <label class="series-list__main-filter-category-checkbox-label" for="Action">Action 1</label>
    ...
    <div class="data-block">
      <h2 class="data-block__title">Series</h2>
      ...
      <div class="data-block__content-pagination">
      </div>
    </div>
  </div>
 </section>

...
let searchGame = function (number, target) {
  ...
  //Проверки чисел на диапазон от 0 до 100
  ...
  while (startPoint <= endPoint) {
    //Определям серидину масиса, получаем 50.
    ...
    if (equals) {
      ...
      //Если загаданое число меньше 50, передвигаем endPoint к 49, после чего делим этот масив на 2 и повторяем опрос
      if (lessThen50) {
        endPoint = midPoint - 1;
        console.log(endPoint);
        //Если загаданое число больше 50, то передвигаем старт масива к 51, после чего делим этот масив на 2 и повторяем опрос
      } else {
